 ...
 public class Boulder1 extends Elementsbyg.ModElement {
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 100000) {
       ...
       if (((ResourceLocation)Biome.REGISTRY.getNameForObject(earlyBiome)).equals(new ResourceLocation("byg:bgrasslandplateau")))
         earlyBiomeCriteria = true;
       if (((ResourceLocation)Biome.REGISTRY.getNameForObject(earlyBiome)).equals(new ResourceLocation("byg:bsnowypinemountains")))
         earlyBiomeCriteria = true;
       if (((ResourceLocation)Biome.REGISTRY.getNameForObject(earlyBiome)).equals(new ResourceLocation("byg:bstone_brushlands")))
         earlyBiomeCriteria = true;
