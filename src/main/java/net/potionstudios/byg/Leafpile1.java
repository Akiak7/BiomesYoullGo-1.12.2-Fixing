 ...
 public class Leafpile1 extends Elementsbyg.ModElement {
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 1000000) {
       ...
       if (((ResourceLocation)Biome.REGISTRY.getNameForObject(earlyBiome)).equals(new ResourceLocation("byg:bredoakforest")))
         earlyBiomeCriteria = true;
       ...
       if (((ResourceLocation)Biome.REGISTRY.getNameForObject(earlyBiome)).equals(new ResourceLocation("byg:bevergreentaiga")))
         earlyBiomeCriteria = true;
       if (((ResourceLocation)Biome.REGISTRY.getNameForObject(earlyBiome)).equals(new ResourceLocation("byg:bborealforest")))
         earlyBiomeCriteria = true;
       ...
       if (((ResourceLocation)Biome.REGISTRY.getNameForObject(earlyBiome)).equals(new ResourceLocation("byg:bgreatlakes")))
         earlyBiomeCriteria = true;
       if (((ResourceLocation)Biome.REGISTRY.getNameForObject(earlyBiome)).equals(new ResourceLocation("byg:bebonywoods")))
         earlyBiomeCriteria = true;
