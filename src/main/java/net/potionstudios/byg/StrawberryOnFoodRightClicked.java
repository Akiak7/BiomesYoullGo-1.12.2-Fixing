  ...
  extends Elementsbyg.ModElement
{
  ...
  public static boolean executeProcedure(HashMap<String, Object> dependencies) {
    ...
    if (dependencies.get("hand") == null) {
      System.err.println("Failed to load dependency hand for procedure StrawberryOnFoodRightClicked!");
      return false;
    }
    if (dependencies.get("side") == null) {
      System.err.println("Failed to load dependency side for procedure StrawberryOnFoodRightClicked!");
      return false;
    }
    ...
    return BYGPlantPlacementHelper.placeHeldItemRelative(world, new BlockPos(x, y, z), player, hand, side, Strawberry.block, Blocks.FARMLAND, Strawberrybushstage0.block, EnumFacing.UP);
  }
