 ...
 public class MangrovedoortopOnBlockRightClicked extends Elementsbyg.ModElement {
   ...
   public static void executeProcedure(HashMap<String, Object> dependencies) {
     ...
     BYGDoorGateStateHelper.replaceDoorFromTop(world, new BlockPos(x, y, z), Mangrove_door_open_bottom.block.getDefaultState(), Mangrove_door_open_top.block.getDefaultState(), 3);
   }
 }
