 ...
 public class Baobabstage3OnBlockRightClicked extends Elementsbyg.ModElement {
  ...
  public static boolean executeProcedure(HashMap<String, Object> dependencies) {
    ...
    if (dependencies.get("hand") == null) {
      System.err.println("Failed to load dependency hand for procedure Baobabstage3OnBlockRightClicked!");
      return false;
    }
    ...
    if (BYGBonemealGrowthHelper.isHeldBonemeal(entity, hand)) {
      if (!world.isRemote) {
        ...
        if (Math.random() < 0.4D) {
          ...
          world.setBlockState(pos, Baobabfruitblock.block.getDefaultState(), 3);
