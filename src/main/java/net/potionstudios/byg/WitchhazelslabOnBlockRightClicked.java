 ...
 public class WitchhazelslabOnBlockRightClicked
   ...
   public static boolean executeProcedure(HashMap<String, Object> dependencies) {
     ...
     if (dependencies.get("hand") == null) {
       System.err.println("Failed to load dependency hand for procedure WitchhazelslabOnBlockRightClicked!");
       return false;
     }
     ...
     if (!(entity instanceof EntityPlayer))
       return false;
     return BYGSlabInteractionHelper.combineHeldSlab(world, new BlockPos(x, y, z), (EntityPlayer)entity, hand, Witchhazelslab.block, Witchhazelplanks.block);
   }
 }
