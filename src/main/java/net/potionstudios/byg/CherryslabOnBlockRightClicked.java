 ...
 public class CherryslabOnBlockRightClicked
   ...
   public static boolean executeProcedure(HashMap<String, Object> dependencies) {
     ...
     if (dependencies.get("hand") == null) {
       System.err.println("Failed to load dependency hand for procedure CherryslabOnBlockRightClicked!");
       return false;
     }
     ...
     if (!(entity instanceof EntityPlayer))
       return false;
     return BYGSlabInteractionHelper.combineHeldSlab(world, new BlockPos(x, y, z), (EntityPlayer)entity, hand, Cherryslab.block, Cherryplanks.block);
   }
 }
