 ...
 public class SkyrisplanksOnBlockRightClicked extends Elementsbyg.ModElement {
   ...
   public static void executeProcedure(HashMap<String, Object> dependencies) {
     ...
     BYGDoorGateStateHelper.replaceDoorFromBottom(world, new BlockPos(x, y, z), Skyris_door_open_bottom.block.getDefaultState(), Skyris_door_open_top.block.getDefaultState(), 3);
   }
 }
