 ...
 public class Rudostage2OnBlockRightclicked
  ...
  public static boolean executeProcedure(HashMap<String, Object> dependencies) {
    ...
    if (dependencies.get("hand") == null) {
      System.err.println("Failed to load dependency hand for procedure Rudostage2OnBlockRightclicked!");
      return false;
    }
    ...
    if (!(entity instanceof EntityPlayer))
      return false;
    return BYGBonemealGrowthHelper.growSimpleStage(world, new BlockPos(x, y, z), (EntityPlayer)entity, hand, Rudostage3.block);
  }
}
