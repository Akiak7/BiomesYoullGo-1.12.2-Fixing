  ...
  extends Elementsbyg.ModElement
{
  ...
  public static boolean executeProcedure(HashMap<String, Object> dependencies) {
    ...
    if (dependencies.get("hand") == null) {
      System.err.println("Failed to load dependency hand for procedure BaobabfruitOnFoodRightClicked!");
      return false;
    }
    if (dependencies.get("side") == null) {
      System.err.println("Failed to load dependency side for procedure BaobabfruitOnFoodRightClicked!");
      return false;
    }
    ...
    return BYGPlantPlacementHelper.placeHeldItemRelative(world, new BlockPos(x, y, z), player, hand, side, Baobabfruit.block, Baobableaves.block, Baobabstage0.block, EnumFacing.DOWN);
  }
