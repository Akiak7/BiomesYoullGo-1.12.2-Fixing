 ...
 public class Palmtree2 extends Elementsbyg.ModElement {
   ...
   public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
     ...
     if (random.nextInt(1000000) + 1 <= 80000) {
       ...
       if (((ResourceLocation)Biome.REGISTRY.getNameForObject(earlyBiome)).equals(new ResourceLocation("byg:btropical_islands")))
         earlyBiomeCriteria = true;
       if (((ResourceLocation)Biome.REGISTRY.getNameForObject(earlyBiome)).equals(new ResourceLocation("beaches")))
         earlyBiomeCriteria = true;
