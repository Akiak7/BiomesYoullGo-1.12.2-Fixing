 ...
 public class WitchhazeldoorRightClickedOnBlock extends Elementsbyg.ModElement {
   ...
   public static void executeProcedure(HashMap<String, Object> dependencies) {
     ...
     if (!((entity instanceof EntityPlayer) ? ((EntityPlayer)entity).capabilities.isCreativeMode : false)) {
       ...
       BYGDoorGateStateHelper.placeDoor(world, new BlockPos(x, y + 1, z), Witch_hazel_door_bottom.block.getDefaultState(), Witch_hazel_door_top.block.getDefaultState(), entity, 3);
