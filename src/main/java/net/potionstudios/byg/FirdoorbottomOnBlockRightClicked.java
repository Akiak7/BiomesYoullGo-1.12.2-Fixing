 ...
 public class FirdoorbottomOnBlockRightClicked extends Elementsbyg.ModElement {
   ...
   public static void executeProcedure(HashMap<String, Object> dependencies) {
     ...
     BYGDoorGateStateHelper.replaceDoorFromBottom(world, new BlockPos(x, y, z), Fir_door_open_bottom.block.getDefaultState(), Fir_door_open_top.block.getDefaultState(), 3);
   }
 }
